...
function Login() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-6 py-8 font-[Poppins]">
      <section className="grid min-h-[620px] w-full max-w-6xl overflow-hidden rounded-[28px] bg-white shadow-2xl shadow-slate-200 lg:grid-cols-2">
